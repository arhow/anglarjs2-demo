...
@Component({
  ...
  template: `<div  style="width: 200px;margin-top: 15px;"><ba-file-uploader [fileUploaderOptions]="fileUploaderOptions"></ba-file-uploader></div>`,
})
export class UploadCell extends DefaultEditor implements OnInit, AfterViewInit{
  ...
  ngOnInit(){
    ...
    this.fileUploaderOptions = {
        ...
        url: CONSTANT.URL.UPLOAD_SALES_PHOTOCOPY,
        multipart: true,
        data: data,
    };
  }
